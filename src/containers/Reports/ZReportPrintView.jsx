            ...
            <div className="modal-child">
                ...
                <div>
                    ...
                    <div className="row">
                        ...
                        <label style={{ marginLeft: "30px", marginRight: "30px" }}className="labelmain pull-right" >{get(this.props, 'data.preTaxSalesAmount', 0)}</label>
                    </div>
                    <div className="row">
                        <label style={{ marginLeft: "30px", marginRight: "30px" }}className="labelmain pull-left" >Tax</label>
                        <label style={{ marginLeft: "30px", marginRight: "30px" }} className="labelmain pull-right" >{get(this.props, 'data.taxAmount', 0)}</label>
                    </div>
                    <div className="row">
                        <label style={{ marginLeft: "30px", marginRight: "30px" }} className="labelmain pull-left" >Total Sales</label>
                        <label style={{ marginLeft: "30px", marginRight: "30px" }} className="labelmain pull-right" >{get(this.props, 'data.totalSalesAmount', 0)}</label>
                    </div>
                    <div className="row">
                ...
                <div>
                    ...
                    <div className="row">
                        ...
                        <label style={{ marginLeft: "30px", marginRight: "30px" }} className="labelmain pull-right" >{get(this.props, 'data.cardSales', 0)}</label>
                    </div>
                    <div className="row">
