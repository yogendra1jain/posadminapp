...
class EmployeeDiscountReport extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            startDate: moment(),
            ...
            <div>
                <div className="row">
                    <div className="col-sm-6 col-xs-8">
                        <ul className="breadcrumb" >
                            <li>Employee Discount Report</li>
                        </ul>
                    </div>
                </div>
                ...
                <div>
                    <BootstrapTable
                        ...
                        <TableHeaderColumn width='100' dataField='total' dataSort>Total</TableHeaderColumn>
                        <TableHeaderColumn width='100' dataField='employeeDiscount' dataSort>Employee Discount</TableHeaderColumn>
...
export default connect(mapStateToProps)(EmployeeDiscountReport);
